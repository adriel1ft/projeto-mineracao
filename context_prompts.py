context_q2 = r"""The input I give you and the output I expect
...
You receive in input a draft DFM
...
context_q3 = r"""The input I give you and the output I expect
are DFM schemata in YAML formatted as follows: (1)
the fact is a “fact” tag including a “name” tag; (2) all
measures are listed inside a “measures” tag, each is an
empty item containing a “name” tag; (3) all many-to-
...
(2) Classify measures into additive, semi-additive, or non-additive. If you find a measure is non-additive, i.e., it can never be summed (e.g., the unit price of a product, a currency exchange, or a discount percentage), you should add “(AVG)” to its name.
